...
// Define the discriminated union separately to help with type inference.
export const BlockOperationPayloadSchema = z.preprocess(
  preprocessJson,
...
export const BLOCKS_OPERATION_SCHEMA = {
  payload: BlockOperationPayloadSchema,
};
